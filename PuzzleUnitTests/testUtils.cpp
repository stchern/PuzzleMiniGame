...
void TestUtils::testAdjacencyMatrix01()
{
    ...
    std::vector<std::vector<Position>> positions = Utils::beginningSequencesList(matrix, sequences);
    ...
    std::vector<std::vector<std::pair<Path, int>>> possiblePathsAndScore {
        {
            ...
            std::make_pair(Path({{0, 1}, {2, 1}, {2, 0}, {1, 0}, {1, 3}, {0, 3}, {0, 2}}), 11),
            std::make_pair(Path({{0, 1}, {2, 1}, {2, 0}, {1, 0}, {1, 2}, {0, 2}}), 11),
            std::make_pair(Path({{0, 1}, {2, 1}, {2, 0}, {1, 0}, {1, 2}, {0, 2}, {0, 3}}), 11),
            std::make_pair(Path({{0, 1}, {2, 1}, {2, 0}, {1, 0}, {1, 3}, {0, 3}}), 11),
        },
        {
            std::make_pair(Path({{0, 2}}), 1)
        },
        {
            std::make_pair(Path({{0, 3}}), 1)
        }
    };

    Path resultPath = Utils::findBestPath(possiblePathsAndScore);
    Path ansResultPath({{0, 1}, {2, 1}, {2, 0}, {1, 0}, {1, 2}, {0, 2}});
...
void TestUtils::testCombinePurePaths01()
{
    ...
    std::vector<std::vector<std::pair<Path, int>>> ansPossiblePathsAndScore {
        {
            std::make_pair(Path({{0, 1}, {2, 1}, {2, 0}, {1, 0}}), 10),
            std::make_pair(Path({{0, 1}, {2, 1}, {2, 0}, {1, 0},
                                 {1, 3}, {2, 3}, {2, 2}, {1, 2}}), 15),
            std::make_pair(Path({{0, 1}, {2, 1}, {2, 0}, {1, 0}, {1, 2}}), 15)
        },
        {
            std::make_pair(Path({{0, 0}, {1, 0}, {1, 3}, {2, 3}, {2, 2}, {1, 2}}), 5),
            std::make_pair(Path({{0, 1}, {1, 1}, {1, 3}, {2, 3}, {2, 2}, {1, 2}}), 5),
        },
        {
            std::make_pair(Path({{0, 1}, {2, 1}, {2, 0}, {1, 0}, {1, 2}}), 5),
            std::make_pair(Path({{0, 1}, {2, 1}, {2, 0}, {1, 0}, {1, 2}}), 15)
        }
    };
    ...
    std::vector<std::vector<std::pair<Path, int>>> ansPossiblePathsAndScore {
        {
            ...
            std::make_pair(Path({{0, 1}, {1, 1}, {1, 3}, {2, 3}, {2, 2}, {1, 2}}), 10),
            std::make_pair(Path({{0, 1}, {1, 1}, {1, 3}, {2, 3}, {2, 2}, {1, 2}}), 15),
        ...
        },
        {
            ...
            std::make_pair(Path({{0, 1}, {1, 1}, {1, 3}, {2, 3}}), 5),
            std::make_pair(Path({{0, 1}, {1, 1}, {1, 3}, {2, 3}, {2, 2}, {1, 2}}), 15),

            std::make_pair(Path({{0, 2}, {1, 2}, {1, 3}, {2, 3}}), 5),
            std::make_pair(Path({{0, 2}, {1, 2}, {1, 3}, {2, 3}, {2, 2}, {1, 2}}), 15),
        },
        {
            std::make_pair(Path({{0, 1}, {2, 1}, {2, 3}}), 5),
        },
